...
class CSR:
    ...
    def generate_csr(key):
        csr = x509.CertificateSigningRequestBuilder().subject_name(x509.Name([
            ...
            x509.NameAttribute(NameOID.ORGANIZATION_NAME, u"Bit(e)"),
            x509.NameAttribute(NameOID.COMMON_NAME, u"Bit(e)"),
        ])).add_extension(
            x509.SubjectAlternativeName([
                # Describe what sites we want this certificate for.
                x509.DNSName(u"Bit(e).com"),
                x509.DNSName(u"www.Bit(e).com"),
                x509.DNSName(u"subdomain.Bit(e).com"),
            ]),
            critical=False,
